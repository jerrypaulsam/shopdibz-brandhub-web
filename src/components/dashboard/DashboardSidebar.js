...
const menuItems = [
  ...
  ["New Product", "/products/new/category", "+P"],
  ["Orders", "/orders-list?tab=pending", "O"],
  ["Coupons", "/coupons-list", "C"],
  ["Payments", "/payments-list?tab=pending", "Rs"],
  ...
  ["Store Sliders", "/store-slider-management", "Sl"],
  ["New Sliders", "/store-slider-image-form", "+S"],
