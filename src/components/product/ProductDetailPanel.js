      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.2fr)_minmax(320px,420px)]">
                ...
                <div className="rounded-sm border border-white/10 bg-black/20 p-3" key={image.id}>
                  ...
                  <div className="mt-3 space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {!image.cover ? (
                        <button
                          className="rounded-sm border border-white/10 px-3 py-2 text-[11px] font-bold uppercase tracking-[0.14em] text-brand-white hover:border-brand-gold hover:text-brand-gold"
                          type="button"
                      ...
                      <button
                        className="rounded-sm border border-red-400/35 px-3 py-2 text-[11px] font-bold uppercase tracking-[0.14em] text-red-300 hover:border-red-300 hover:text-red-200"
                        type="button"
        ...
        >
          <div className="space-y-4">
            <div>
              <h2 className="text-2xl font-black text-brand-white">{product?.title}</h2>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                ["Approval", product?.aprvd ? "Approved" : "Pending approval"],
              ].map(([label, value]) => (
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="mt-1 h-8 w-8 rounded-full border border-white/10 bg-brand-black text-center text-sm font-bold leading-8 text-brand-gold">
                      ?
                    </div>
                    <div className="min-w-0 flex-1">
                      ...
                      {firstAnswer ? (
                        <div className="mt-4 rounded-sm border border-white/10 bg-black/25 p-3">
                          ...
                          <button
                            className="mt-3 text-xs font-bold uppercase tracking-[0.14em] text-red-300 hover:text-red-200"
                            type="button"
